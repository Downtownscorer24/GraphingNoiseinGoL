...
def main():
    ...
    one_less_legend = plt.Line2D((0, 1), (0, 0), color='white')  # this line is for the legend, not to be plotted
    one_more_legend = plt.Line2D((0, 1), (0, 0), color='white')  # this line is for the legend, not to be plotted

    # Update the legend position
    ax1.legend([one_less_legend, one_more_legend] + [line for line in ax1.lines],
               [f'one_less: {one_less}', f'one_more: {one_more}'] + [f'Run {run + 1}' for run in
